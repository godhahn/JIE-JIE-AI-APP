...
if st.button("Create Task"):
    prompt = f"With a task named '{task_name}', and the following details: '{task_details}', and a priority of {priority}. Give advice and explain how to plan it effectively, in point form."
